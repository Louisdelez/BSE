...
[![Version: v006](https://img.shields.io/badge/Version-v006-green.svg)](./CHANGELOG.md)
...
> **v006 — Outil Pen (perfect-freehand) opérationnel.**
> Tracé pressure-sensible naturel, porté en Rust par un agent en parallèle.
> Quadtree culling en v007, server axum en v008, yrs CRDT en v009, SQLite en v011 (code prêt par agents).
